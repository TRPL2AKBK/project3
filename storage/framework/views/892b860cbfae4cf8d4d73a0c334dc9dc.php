...
<?php if($message = Session::get('failed')): ?>
    <script>swal('<?php echo e($message); ?>','Periksa kembali');</script>
<?php endif; ?>

<?php if($message = Session::get('success')): ?>
    <script></script>
    <script>swal('<?php echo e($message); ?>');</script>
<?php endif; ?>
</body>
</html>
<?php /**PATH C:\Users\Lenovo\Documents\GitHub\project3\KBK_TI\resources\views/auth/login.blade.php ENDPATH**/ ?>