...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('verifikasi_rps', function (Blueprint $table) {
            $table->foreign(['id_pengurus'], 'fk_vrps_pengurus')->references(['id'])->on('ref_pengurus_kbk')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign(['id_rps'], 'fk_vrps_rps')->references(['id'])->on('ref_rps')->onUpdate('cascade')->onDelete('cascade');
