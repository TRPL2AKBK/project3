...
<head>
    ...
    <title>Berita Acara Verifikasi Soal</title>
    <style>
        body {
    ...
    <div class="content">
        <div class="header">
            <table>
                ...
                <tr>
                    <td>
                        <h4 style="text-transform: uppercase;">VERIFIKASI SOAL UJIAN AKHIR SEMESTER <br>
                            JURUSAN : TEKNOLOGI INFORMASI PROGRAM STUDI : {{ $kaprodi->prodi }}</h4>
                    </td>
                </tr>
            </table>
        </div>
        <p>Telah dilaksanakan rapat Peninjauan materi Soal besama KBK dan Kaprodi yang dilaksanakan pada:</p>
        ...
        <table>
            ...
            @foreach ($dataVerif as $data)
                <tr>
                    ...
                    <td>
                        {{-- {{ $data->soal->matakuliah->semester }} --}}
                        {{-- {{ angkaKeRomawi($data->soal->matakuliah->semester) }}
                        ({{ angkaKeTeks($data->soal->matakuliah->semester) }}) --}}
                        {{ \App\Helpers\NumberHelper::angkaKeRomawi($data->soal->matakuliah->semester) }}
                        ({{ \App\Helpers\NumberHelper::angkaKeTeks($data->soal->matakuliah->semester) }})
                    </td>
                    <td> {{ $data->soal->matakuliah->nama_matakuliah }} </td>
                    {{-- <td> {{ $data->soal->matakuliahkbk->id_kbk }} </td> --}}
                    <td> {{ $data->evaluasi }} </td>
                </tr>
            @endforeach
        </table>
