                    ...
                    {{-- <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>
                                    @if ($matakuliah > 0)
                                        {{ number_format(($dataRps->count() / $matakuliah) * 100, 2) }}%
                                    @else
                                        0%
                                    @endif
                                </h3>
                                <p>RPS sudah diupload</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-file"></i>
                            </div>
                            <a href="{{ route('verifikasi.rps') }}" class="small-box-footer">Lebih lanjut <i
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>
                                    @if ($verifRps->count() > 0)
                                        {{ number_format(($verifRps->count() / $dataRps->count()) * 100, 2) }}%
                                    @else
                                        0%
                                    @endif
                                </h3>
                                <p>RPS sudah diverifikasi</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-check-circle"></i>
                            </div>
                            <a href="{{ route('verifikasi.verifrps') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>
                                    @if ($matakuliah > 0)
                                        {{ number_format(($dataSoal->count() / $matakuliah) * 100, 2) }}%
                                    @else
                                        0%
                                    @endif
                                </h3>
                                <p>Soal sudah diupload</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-file"></i>
                            </div>
                            <a href="{{ route('verifikasi.soal') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                            ...
                            <div class="inner">
                                <h3>
                                    @if ($verifSoal->count() > 0)
                                        {{ number_format(($verifSoal->count() / $dataSoal->count()) * 100, 2) }}%
                                    @else
                                        0%
                                    @endif
                                </h3>
                                <p>Soal sudah diverifikasi</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-check-circle"></i>
                            </div>
                            <a href="{{ route('verifikasi.verifsoal') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div> --}}
                    <!-- ./col -->
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['RPS diupload', 'RPS diverifikasi', 'Soal diupload',
                        'Soal diverifikasi'
                    ],
                    datasets: [{
                        label: 'Persentase',
